...
<div class="mb-6">
    ...
    <h1 class="text-xl font-bold text-slate-900">Aggiungi veicolo</h1>
    <p class="text-sm text-slate-500 mt-0.5">Inserisci i dati del veicolo e configura gli assi.</p>
</div>

<form method="POST" action="{{ route('my.vehicles.store') }}">
    @csrf
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div class="sm:col-span-2">
                <label class="block text-sm font-medium text-slate-700 mb-1">
                    Azienda <span class="text-red-500">*</span>
                </label>
            ...
            <div>
                ...
                <input type="text" name="targa" value="{{ old('targa') }}"
                       maxlength="15" placeholder="es. AB123CD"
            ...
            <div>
                ...
                <input type="text" name="numero_telaio" value="{{ old('numero_telaio') }}"
                       maxlength="17"
            ...
            <div>
                ...
                <input type="number" name="anno_immatricolazione" value="{{ old('anno_immatricolazione') }}"
    ...
    <div class="bg-white rounded-xl border border-slate-200 p-6 mb-4">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
            <div>
                ...
                <input type="number" name="massa_vuoto" value="{{ old('massa_vuoto') }}"
                       min="0" placeholder="es. 10000"
                       class="w-full rounded-lg border border-slate-300 px-3 py-2 text-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none">
                @error('massa_vuoto')
                    <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                @enderror
            ...
            <div>
                ...
                <input type="number" name="massa_complessiva" value="{{ old('massa_complessiva') }}"
                       min="0" placeholder="es. 44000"
                       class="w-full rounded-lg border border-slate-300 px-3 py-2 text-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none">
        ...
        <div class="grid grid-cols-3 gap-4">
            <div>
                ...
                <input type="number" name="lunghezza" value="{{ old('lunghezza') }}"
                       min="0" placeholder="es. 18750"
                       class="w-full rounded-lg border border-slate-300 px-3 py-2 text-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none">
                @error('lunghezza')
                    <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                @enderror
            ...
            <div>
                ...
                <input type="number" name="larghezza" value="{{ old('larghezza') }}"
                       min="0" placeholder="es. 2550"
                       class="w-full rounded-lg border border-slate-300 px-3 py-2 text-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none">
                @error('larghezza')
                    <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                @enderror
            ...
            <div>
                ...
                <input type="number" name="altezza" value="{{ old('altezza') }}"
                       min="0" placeholder="es. 4000"
                       class="w-full rounded-lg border border-slate-300 px-3 py-2 text-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none">
                @error('altezza')
                    <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                @enderror
